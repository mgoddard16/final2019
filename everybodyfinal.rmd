...
## Conclusions
Based on the results of both the chi-square test and the fishers test the placebo is working for this group so we will eject the null hypothesis because the odds of 1 is far from being there. The test we used was to see if the odds of getting aids was a 1:1 ratio and it was far from it. 